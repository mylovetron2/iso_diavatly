...
echo "<!DOCTYPE HTML PUBLIC '-//W3C//DTD HTML 4.01 Transitional//EN' 'http://www.w3.org/TR/html4/loose.dtd'>
	...
	<body>";
echo "
<Span class=\"printspan\"><center>XƯỞNG SỬA CHỮA VÀ CHUẨN CHỈNH MÁY<br/>LIỆT KÊ LINH KIỆN VẬT TƯ SỬA CHỮA</center></br></span>
<div class=\"noprint\">
<section class=\"tabs\">
...
<input id=\"tab-3\" type=\"radio\" name=\"radio-set\" class=\"tab-selector-3\" onClick=\"window.location.href='danhmucvattu.php'\"  checked=\"checked\" />
<label for=\"tab-3\" class=\"tab-label-3\">THỐNG KÊ VẬT TƯ SC</label>
...
require_once("mte/mte_danhmucvattu.php");
...
$tabledit->table = 'danhmucvattu_iso';

# the primary key of the table (must be AUTO_INCREMENT)
$tabledit->primary_key = 'stt';

# the fields you want to see in "list view"
$tabledit->fields_in_list_view = array('stt','mavattu','mota','serialnumber','dvt','soluong','ngayth');
...
$tabledit->num_rows_list_view = 12;
