...
require_once("mte/mte_vitri.php");
...
$tabledit->fields_required = array('mavitri');
...
<div class=\"noprint\">	
<section class=\"tabs\">
<input id=\"tab-1\" type=\"radio\" name=\"radio-set\" class=\"tab-selector-1\"  onClick=\"window.location.href='vitri.php'\"/>
<label for=\"tab-1\" class=\"tab-label-1\">NHẬP VỊ TRÍ</label>
