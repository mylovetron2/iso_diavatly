...
session_start();
require_once("mte/mte_quanlyuser.php");
...
echo " 
<section class=\"tabs\">
<input id=\"tab-1\" type=\"radio\" name=\"radio-set\" class=\"tab-selector-1\"  onClick=\"window.location.href='quanlyuser.php'\"  checked=\"checked\"/>
<label for=\"tab-1\" class=\"tab-label-1\">QUẢN LÝ USER</label>
<input id=\"tab-2\" type=\"radio\" name=\"radio-set\" class=\"tab-selector-2\" onClick=\"window.location.href='lichsudn.php'\"/>
