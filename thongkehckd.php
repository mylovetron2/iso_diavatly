...
<font size=\"+1\"><center><b> THỐNG KÊ VIỆC THỰC HIỆN HC-KD<br/>Xưởng sửa chữa thiết bị Địa vật lý</center></b></font>
<form action=\"thongkehckd.php\" method=\"post\" name=\"example\">
<br/>
...
<th style=\"text-align:center;font-size: 15;width:80px;\">TỔNG SỐ THIẾT BỊ</th>
<th style=\"text-align:center;font-size: 15;width:80px;\">SỐTHIẾT BỊ THEO KẾ HOẠCH</th>
<th style=\"text-align:center;font-size: 15;width:80px;\">SỐ THIẾT BỊ ĐỘT XUẤT</th>
<th style=\"text-align:center;font-size: 15;width:80px;\">SỐ THIẾTBỊ KHÔNG ĐỦ ĐIỀU KIỆN LÀM VIỆC</th>
<th style=\"text-align:center;font-size: 15;width:80px;\">% THỰC HIỆN ĐÚNG THEO KẾ HOACH</th>
...
$percent=0;
		if($month>=1&&$month<=12){
			$result1 = mysql_query("SELECT count(*) as sum FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-$month-1 00:00:00' AND '$year-$month-31 00:00:00'") ;
		while($row = mysql_fetch_array($result1))
		{
			$sum =$row['sum'];	
		}
		$result2 = mysql_query("SELECT count(*) as sumkh FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-$month-1 00:00:00' AND '$year-$month-31 00:00:00' AND dinhky='on'") ;
		while($row = mysql_fetch_array($result2))
		{
			$sumkh =$row['sumkh'];	
		}
		$result3 = mysql_query("SELECT count(*) as sumdx FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-$month-1 00:00:00' AND '$year-$month-31 00:00:00' AND dotxuat='on'") ;
		while($row = mysql_fetch_array($result3))
		{
			$sumdx =$row['sumdx'];	
		}
		$result4 = mysql_query("SELECT count(*) as sumh FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-$month-1 00:00:00' AND '$year-$month-31 00:00:00' and ttkt='Hỏng'") ;
		while($row = mysql_fetch_array($result4))
		{
			$sumh =$row['sumh'];	
		}
		$result5 = mysql_query("SELECT  mahieu FROM kehoach_iso WHERE thang ='$month' AND namkh='$year'") ;
		while($row = mysql_fetch_array($result5))
		{
			$mahieu =$row['mahieu'];
		$result6 = mysql_query("SELECT ngayhc FROM hosohckd_iso WHERE tenmay='$mahieu'AND namkh='$year' and dinhky='on'") ;
		while($row = mysql_fetch_array($result6))
		{
			
			$ngayhc =$row['ngayhc'];
			$thhc = date("m",strtotime("$ngayhc"));
			if ($thhc>$month) {
				$sume++;
				$ghichu.= "$mahieu </br>";
			}	
		...
		$number=$sumkh-$sume;
		if ($sumkh!=0)
		$percent = round($number/$sumkh*100,2);
			echo"
			<tr>
			...
			<td style=\"text-align:center;color:black;font-size: 15;\"> $sumkh</td>
			<td style=\"text-align:center;color:black;font-size: 15;\"> $sumdx</td>
			<td style=\"text-align:center;color:black;font-size: 15;\"> $sumh</td>
			<td style=\"text-align:center;color:black;font-size: 15;\"> $percent%</td>
			<td style=\"text-align:color:black;font-size: 15;\"> $ghichu </td>
			</tr>";
		echo"
			</table>
			...
			"; 
				...
				$result1 = mysql_query("SELECT count(*) as sum FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-1-1 00:00:00' AND '$year-3-31 00:00:00'") ;
		while($row = mysql_fetch_array($result1))
		{
			$sum =$row['sum'];	
		}
		$result2 = mysql_query("SELECT count(*) as sumkh FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-1-1 00:00:00' AND '$year-3-31 00:00:00' AND dinhky='on'") ;
		while($row = mysql_fetch_array($result2))
		{
			$sumkh =$row['sumkh'];	
		}
		$result3 = mysql_query("SELECT count(*) as sumdx FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-1-1 00:00:00' AND '$year-3-31 00:00:00' AND dotxuat='on'") ;
		while($row = mysql_fetch_array($result3))
		{
			$sumdx =$row['sumdx'];	
		}
		$result4 = mysql_query("SELECT count(*) as sumh FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-1-1 00:00:00' AND '$year-3-31 00:00:00' and ttkt='Hỏng'") ;
		while($row = mysql_fetch_array($result4))
		{
			$sumh =$row['sumh'];	
		}
		for ($i=1;$i<=3;$i++) {
		$result5 = mysql_query("SELECT  mahieu FROM kehoach_iso WHERE thang ='$i' AND namkh='$year'") ;
		while($row = mysql_fetch_array($result5))
		{
			$mahieu =$row['mahieu'];
		$result6 = mysql_query("SELECT ngayhc FROM hosohckd_iso WHERE tenmay='$mahieu'AND namkh='$year' and dinhky='on'") ;
		...
		$percent = round($number/$sumkh*100,2);
			echo"
			<tr>
			<td style=\"text-align:center;color:black;font-size: 15;\"> Quý $month </td>
			<td style=\"text-align:center;color:black;font-size: 15;\"> $sum </td>
			<td style=\"text-align:center;color:black;font-size: 15;\"> $sumkh</td>
			<td style=\"text-align:center;color:black;font-size: 15;\"> $sumdx</td>
			<td style=\"text-align:center;color:black;font-size: 15;\"> $sumh</td>
			...
			$result1 = mysql_query("SELECT count(*) as sum FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-4-1 00:00:00' AND '$year-6-31 00:00:00'") ;
		while($row = mysql_fetch_array($result1))
		{
			$sum =$row['sum'];	
		}
		$result2 = mysql_query("SELECT count(*) as sumkh FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-4-1 00:00:00' AND '$year-6-31 00:00:00' AND dinhky='on'") ;
		while($row = mysql_fetch_array($result2))
		{
			$sumkh =$row['sumkh'];	
		}
		$result3 = mysql_query("SELECT count(*) as sumdx FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-4-1 00:00:00' AND '$year-6-31 00:00:00' AND dotxuat='on'") ;
		while($row = mysql_fetch_array($result3))
		{
			$sumdx =$row['sumdx'];	
		}
		$result4 = mysql_query("SELECT count(*) as sumh FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-4-1 00:00:00' AND '$year-6-31 00:00:00' and ttkt='Hỏng'") ;
		while($row = mysql_fetch_array($result4))
		{
			$sumh =$row['sumh'];	
		}
		...
		$percent = round($number/$sumkh*100,2);
			...
			$result1 = mysql_query("SELECT count(*) as sum FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-7-1 00:00:00' AND '$year-9-31 00:00:00'") ;
		while($row = mysql_fetch_array($result1))
		{
			$sum =$row['sum'];	
		}
		$result2 = mysql_query("SELECT count(*) as sumkh FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-7-1 00:00:00' AND '$year-9-31 00:00:00' AND dinhky='on'") ;
		while($row = mysql_fetch_array($result2))
		{
			$sumkh =$row['sumkh'];	
		}
		$result3 = mysql_query("SELECT count(*) as sumdx FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-7-1 00:00:00' AND '$year-9-31 00:00:00' AND dotxuat='on'") ;
		while($row = mysql_fetch_array($result3))
		{
			$sumdx =$row['sumdx'];	
		}
		$result4 = mysql_query("SELECT count(*) as sumh FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-7-1 00:00:00' AND '$year-9-31 00:00:00' and ttkt='Hỏng'") ;
		while($row = mysql_fetch_array($result4))
		{
			$sumh =$row['sumh'];	
		}
		...
		$percent = round($number/$sumkh*100,2);
			...
			$result1 = mysql_query("SELECT count(*) as sum FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-10-1 00:00:00' AND '$year-12-31 00:00:00'") ;
		while($row = mysql_fetch_array($result1))
		{
			$sum =$row['sum'];	
		}
		$result2 = mysql_query("SELECT count(*) as sumkh FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-10-1 00:00:00' AND '$year-12-31 00:00:00' AND dinhky='on'") ;
		while($row = mysql_fetch_array($result2))
		{
			$sumkh =$row['sumkh'];	
		}
		$result3 = mysql_query("SELECT count(*) as sumdx FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-10-1 00:00:00' AND '$year-12-31 00:00:00' AND dotxuat='on'") ;
		while($row = mysql_fetch_array($result3))
		{
			$sumdx =$row['sumdx'];	
		}
		$result4 = mysql_query("SELECT count(*) as sumh FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-10-1 00:00:00' AND '$year-12-31 00:00:00' and ttkt='Hỏng'") ;
		while($row = mysql_fetch_array($result4))
		{
			$sumh =$row['sumh'];	
		}
		...
		$percent = round($number/$sumkh*100,2);
			...
			$result1 = mysql_query("SELECT count(*) as sum FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-1-1 00:00:00' AND '$year-12-31 00:00:00'") ;
		while($row = mysql_fetch_array($result1))
		{
			$sum =$row['sum'];	
		}
		$result2 = mysql_query("SELECT count(*) as sumkh FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-1-1 00:00:00' AND '$year-12-31 00:00:00' AND dinhky='on'") ;
		while($row = mysql_fetch_array($result2))
		{
			$sumkh =$row['sumkh'];	
		}
		$result3 = mysql_query("SELECT count(*) as sumdx FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-1-1 00:00:00' AND '$year-12-31 00:00:00' AND dotxuat='on'") ;
		while($row = mysql_fetch_array($result3))
		{
			$sumdx =$row['sumdx'];	
		}
		$result4 = mysql_query("SELECT count(*) as sumh FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-1-1 00:00:00' AND '$year-12-31 00:00:00' and ttkt='Hỏng'") ;
		while($row = mysql_fetch_array($result4))
		{
			$sumh =$row['sumh'];	
		}
		...
		{
			$mahieu =$row['mahieu'];
		$result6 = mysql_query("SELECT ngayhc FROM hosohckd_iso WHERE tenmay='$mahieu'AND namkh='$year' and dinhky='on' and ttkt!='Hỏng'") ;
		while($row = mysql_fetch_array($result6))
		{
		...
		$percent = round($number/$sumkh*100,2);
			echo"
			<tr>
			<td style=\"text-align:center;color:black;font-size: 15;\"> Năm $year </td>
			<td style=\"text-align:center;color:black;font-size: 15;\"> $sum </td>
			<td style=\"text-align:center;color:black;font-size: 15;\"> $sumkh</td>
			<td style=\"text-align:center;color:black;font-size: 15;\"> $sumdx</td>
			<td style=\"text-align:center;color:black;font-size: 15;\"> $sumh</td>
		...
		echo"</form>";
		for($i=1;$i<=12;$i++){
$result1 = mysql_query("SELECT count(*) as sum FROM hosohckd_iso WHERE ngayhc BETWEEN '$year-$i-1 00:00:00' AND '$year-$i-31 00:00:00'") ;
	while($row = mysql_fetch_array($result1))
	{
		$s[$i] =$row['sum'];	
	}
...
<font style=\"padding-left:50px;\" size=\"+1\" ><b>Biểu đồ HC/KĐ theo tháng</b></font>
<font style=\"padding-left:541px;\" size=\"+1\" color=\"#878BB6\"><b>Số thiết bị theo kế hoạch</b></font>
<font style=\"padding-left:800px;\" size=\"+1\" color=\"#4ACAB4\"><b>Số thiết bị đột xuất </b><br/></font>
