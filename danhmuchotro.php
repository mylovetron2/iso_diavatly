...
require_once("mte/mte_danhmuchotro.php");
...
$tabledit->fields_in_list_view = array('stt','tenthietbi','tenvt','chusohuu','serialnumber','ngaykd','ngaykdtt','cdung','hankd','tlkt','hosomay','thly');
...
<div class=\"noprint\">	
<section class=\"tabs\">
<input id=\"tab-1\" type=\"radio\" name=\"radio-set\" class=\"tab-selector-1\"  onClick=\"window.location.href='Danhmucsc.php'\"/>
<label for=\"tab-1\" class=\"tab-label-1\">DANH MỤC THIẾT BỊ SC-BD</label>
<input id=\"tab-2\" type=\"radio\" name=\"radio-set\" class=\"tab-selector-2\" onClick=\"window.location.href='danhmuchotro.php'\" checked=\"checked\"/>
