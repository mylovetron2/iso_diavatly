...
if ($baocao=="tkhonghoc") header("Location: thongkehonghoc.php");
if ($baocao=="tkscbd")    header("Location: thongke.php"); 
if ($baocao=="dichvungoai")   header("Location: dichvungoai.php"); 
echo "<!DOCTYPE HTML PUBLIC '-//W3C//DTD HTML 4.01 Transitional//EN' 'http://www.w3.org/TR/html4/loose.dtd'>
	...
	<body>";
	echo "
<Span class=\"printspan\"><center>XƯỞNG SỬA CHỮA VÀ CHUẨN CHỈNH MÁY<br/>LIỆT KÊ CÔNG TÁC BẢO DƯỠNG SỬA CHỮA</center></span>
<div class=\"noprint\">
<section class=\"tabs\">
<input id=\"tab-1\" type=\"radio\" name=\"radio-set\" class=\"tab-selector-1\"  onClick=\"window.location.href='baocaothongke.php'\" checked=\"checked\"/>
...
<input id=\"tab-4\" type=\"radio\" name=\"radio-set\" class=\"tab-selector-4\" onClick=\"window.location.href='thongkegiolv.php'\"/>
<label for=\"tab-4\" class=\"tab-label-4\">GIỜ CÔNG LÀM VIỆC</label>
<div class=\"clear-shadow\"></div>
</section></div>";    
require_once("mte/mte_baocaothongke.php");
...
$tabledit->fields_in_list_view = array('stt','hoso','mavt','tenvt','somay','mamay','model','cv','ngayth','ngaykt','ngaysc','ttktafter','nhomsc','phieuktsc','bangsl','lo','gieng','mo','vitrimaybd');
