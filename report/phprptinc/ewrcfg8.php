...
define("EWR_PROJECT_ID", "{C02CCFC4-7C8C-4DFD-B8F7-92DA7EF81CD7}", TRUE); // Project ID
...
// Database connection
define("EWR_CONN_HOST", "$hostname", TRUE);
//define("EWR_CONN_PORT", 3306, TRUE);
define("EWR_CONN_USER", "$usernamehost", TRUE);
define("EWR_CONN_PASS", "$passwordhost", TRUE);
define("EWR_CONN_DB", "$databasename", TRUE);
...
define("EWR_RANDOM_KEY", 's0n6mk1KfCz8M4mk', TRUE); // Random key for encryption
