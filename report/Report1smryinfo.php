...
//	var $SelectLimit = TRUE;
	...
	function __construct() {
		...
		// hoso
		$this->hoso = new crField('Report1', 'Report1', 'x_hoso', 'hoso', '`hoso`', 200, EWR_DATATYPE_STRING, -1);
		...
		// mavt
		$this->mavt = new crField('Report1', 'Report1', 'x_mavt', 'mavt', '`mavt`', 200, EWR_DATATYPE_STRING, -1);
		...
		// cv
		$this->cv = new crField('Report1', 'Report1', 'x_cv', 'cv', '`cv`', 201, EWR_DATATYPE_MEMO, -1);
		...
		// somay
		$this->somay = new crField('Report1', 'Report1', 'x_somay', 'somay', '`somay`', 200, EWR_DATATYPE_STRING, -1);
