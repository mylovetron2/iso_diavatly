	...
	####################
       ...
       # message after add or edit
		...
		if ($_GET['from'] && $_GET['to']){
		    ...
		    if($where_search !="")
			//$sql="SELECT `stt`,date_format(`ngaynk`,'%d-%m-%Y') as ngaynk, `gio1`, `noidungcv1` ,`gio2`,`noidungcv2`,`gio3`, `noidungcv3` ,`gio4`,`noidungcv4`,`gio5` ,`noidungcv5`,`gio6` ,`noidungcv6`,`gio7` ,`noidungcv7`,`gio8` ,`noidungcv8`,`gio9` ,`noidungcv9`,`gio10` ,`noidungcv10`  FROM `nhatky_iso`  $month_string $where_search $order_by";
            $sql="SELECT `stt`,`ngaynk`, `gio1`, `noidungcv1` ,`gio2`,`noidungcv2`,`gio3`, `noidungcv3` ,`gio4`,`noidungcv4`,`gio5` ,`noidungcv5`,`gio6` ,`noidungcv6`,`gio7` ,`noidungcv7`,`gio8` ,`noidungcv8`,`gio9` ,`noidungcv9`,`gio10` ,`noidungcv10`  FROM `nhatky_iso`  $month_string $where_search $order_by";
			else 
		//	$sql="SELECT `stt`,`hoten`,date_format(`ngaynk`,'%d-%m-%Y') as ngaynk, `gio1`, `noidungcv1` ,`gio2`,`noidungcv2`,`gio3`, `noidungcv3` ,`gio4`,`noidungcv4`,`gio5` ,`noidungcv5`,`gio6` ,`noidungcv6`,`gio7` ,`noidungcv7`,`gio8` ,`noidungcv8`,`gio9` ,`noidungcv9`,`gio10` ,`noidungcv10`  FROM `nhatky_iso`  $month_string $where_search $order_by";
            $sql="SELECT `stt`,`hoten`,`ngaynk`, `gio1`, `noidungcv1` ,`gio2`,`noidungcv2`,`gio3`, `noidungcv3` ,`gio4`,`noidungcv4`,`gio5` ,`noidungcv5`,`gio6` ,`noidungcv6`,`gio7` ,`noidungcv7`,`gio8` ,`noidungcv8`,`gio9` ,`noidungcv9`,`gio10` ,`noidungcv10`  FROM `nhatky_iso`  $month_string $where_search $order_by";
					...
					if (in_array($key, $this->fields_in_list_view)) {
						if ($count == 1) {
                            ...
                            if($key==$this->primary_key){
                                $head .= "<td style='width:50px' visibility:collapse><span style=\"font-weight:bold;\">STT</span></td>";
                            }else{
								   if($where_search !="")
                                   if (($key=="hoten")) {
					               $head .= "";
								   ...
								   if (($key=="ngaynk")) 
								   $head .= "<td style='width:100px' NOWRAP><a href='$this->url_script?$query_sort' class='mte_head'>$show_key</a> $sort_image</td>";
								   else if (($key=="gio1")) $head .= "<td style='width:100px;text-align:center' NOWRAP><a href='$this->url_script?$query_sort' class='mte_head'>$show_key</a> $sort_image</td>";
								   else if (($key=="noidungcv1")) $head .= "<td style='text-align:center' NOWRAP><a href='$this->url_script?$query_sort' class='mte_head'>$show_key</a> $sort_image</td>";
								   }
								   else {
								   if (($key=="ngaynk")) $head .= "<td style='width:100px' NOWRAP><a href='$this->url_script?$query_sort' class='mte_head'>$show_key</a> $sort_image</td>";
								   else if (($key=="hoten")) $head .= "<td style='width:120px' NOWRAP><a href='$this->url_script?$query_sort' class='mte_head'>$show_key</a> $sort_image</td>";
								   else if (($key=="gio1")) $head .= "<td style='width:100px;text-align:center' NOWRAP><a href='$this->url_script?$query_sort' class='mte_head'>$show_key</a> $sort_image</td>";
								   else if (($key=="noidungcv1")) $head .= "<td style='text-align:center' NOWRAP><a href='$this->url_script?$query_sort' class='mte_head'>$show_key</a> $sort_image</td>";
								   }
						   }              
						...
						if ($key == $this->primary_key) {
							...
							$this_row .= "<td >$stt</td>";
						        ...
						        if($key=="ngaynk")  {
								$ngaynk=date_create($value);
								$value=  date_format($ngaynk,"d/m/Y");
							   // $ngaynk =  $value;
                                ...
                                $gio=$value;
                                if($gio !="")								
								$this_row = "<td style='border:0px solid white'></td>"."<td style='border:0px solid white'></td>".'<td>' . substr(strip_tags($value), 0, 300) . '</td>';
								}
								if($key=="noidungcv$i"){
								if($gio !=""){	
								$this_row .= '<td>' . substr(strip_tags($value), 0, 300) . '</td>';	
                                ...
                                $gio=$value;
                                if($gio !="")										
								$this_row = "<td style='border:0px solid white'></td>"."<td style='border:0px solid white'></td>"."<td style='border:0px solid white'></td>".'<td>' . substr(strip_tags($value), 0, 300) . '</td>';
							    }
								if($key=="noidungcv$i"){
								if($gio !=""){		
								$this_row .= '<td>' . substr(strip_tags($value), 0, 300) . '</td>';	
		...
		foreach ($this->fields_in_list_view AS $option) {
			...
			if ($option == $in_search_field) {
				...
				if (($option=="stt")||($option=="ngaynk")||($option=="gio1")||($option=="gio2")||($option=="gio3")||($option=="gio4")||($option=="gio5")||($option=="gio6")||($option=="gio7")||($option=="gio8")||($option=="gio9")||($option=="gio10")||($option=="noidungcv1")||($option=="noidungcv2")||($option=="noidungcv3")||($option=="noidungcv4")||($option=="noidungcv5")||($option=="noidungcv6")||($option=="noidungcv7")||($option=="noidungcv8")||($option=="noidungcv9")||($option=="noidungcv10")){}else 
		...
		$seach_form .= "<select name='s'>
        <option value='$in_search_value'>$in_search_value</option>
        <option value=\"\">All</option>"; 								
		$hotensql10 = mysql_query("SELECT DISTINCT hoten  FROM users where madv='XDT'") ;
		while($row = mysql_fetch_array($hotensql10))
		{
			$hotennv =$row['hoten'];
            if($hotennv!="")			
			$seach_form .="<option value=\"$hotennv\" style=\"background:#87CEEB;\"> $hotennv </option>";
		}
		...
		$seach_form .= "
				...
				<td style='padding: 15px; width: $this->width_editor'>
					...
					</form></td><td style='padding: 15px;'><input  style='width:120px;color:red;border: 1px solid #000;height:20px' type=\"submit\" value='In ấn và xuất file' onClick=\"window.location.href='./inanvaxuatfile_nhatky.php?from=$ngayfrom&to=$ngayto&s=$s&f=$f'\" /></td>
			</tr>
			</table>
			</div>
		";
        ...
        $this->javascript = "
            ...
            function info_confirm(id) {
                  ...
                  window.location='filebskt1.php?ID_HoSoKiemDinh=' + id
			}    
