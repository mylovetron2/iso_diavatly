...
echo "<td style='padding: 15px;'><input  style='width:120px;color:red;border: 1px solid #000;height:20px' type=\"submit\" value='In ấn và xuất file' onClick=\"window.location.href='tiendocongviec_excell.php?nhomsc=$nhomsct'\" /></td>";
...
<select name="nhomsc" onchange="this.form.submit()" style="border-style:none;width:100%;height:100%;">
     <?php  echo " <option value=$nhomsct> $ht</option>" ; ?>
...
<p></p>
<div align="center"><strong>CÁC THIẾT BỊ BẢO DƯỠNG ĐỊNH KỲ CỦA XƯỞNG</strong></div>
<?php 
$m = date('m');
$nm = $m+1;
$y = date('Y');
...
?>
 <br/>
  <table width="100%"  cellpadding="0" cellspacing="0" border=1 BORDERCOLOR=black>
    <tr bgcolor="#FF9900">
      <td width="20" height="38" bgcolor="#3399CC"><div align="center" class="style1">STT</div></td>
      <td width="110" nowrap="nowrap" bgcolor="#3399CC"><div align="center" class="style1">Tên viết tắt</div></td>
      <td width="180" nowrap="nowrap" bgcolor="#3399CC"><div align="center" class="style1">Tên Thiết Bị</div></td>
      <td width="100" bgcolor="#3399CC"> <div align="center" class="style2">Chủ sở hưu</div></td>
      <td width="100" bgcolor="#3399CC"><div align="center" class="style2">SerialNumber</div></td>
      <td width="100" bgcolor="#3399CC"><div align="center" class="style2">Ngàu KD/BD</div></td>
      <td width="100" bgcolor="#3399CC"><div align="center" class="style2">Ngày KD/BD tiếp theo</div></td>
      <td width="100" bgcolor="#3399CC"><div align="center" class="style2">Số ngày còn lại</br> ( làm việc)</div></td>
    </tr>
   <?php $stt=0; ?>
<?php
...
while($row=mysql_fetch_array($sql)){
			 ...
			 $ngaykd =$row['ngaykd'];
			 $ngaykdtt =$row['ngaykdtt'];
			 $ngaykdtt=date("d-m-Y", strtotime($ngaykdtt));
...
//if ($ht==1) {
$stt++;
echo "<tr bgcolor=\"$bkcanhbao\">
      <td height=\"49\" style=\"font:'Times New Roman', Times, serif;font-size:15px;padding-left:15px;\">$stt</div></td>
      <td style=\"font:'Times New Roman', Times, serif;font-size:15px;\"><div align=\"center\"><a  href='danhmuchotro.php?&start=0&ad=&sort=&s=&f=&mte_a=edit&id=$id'  title='TLKT' ><span style=\"color:blue;\">$tenthietbi</span></a></div></td>
      <td style=\"font:'Times New Roman', Times, serif;font-size:15px;\"><div align=\"center\">$tenvt</div></td>
      <td style=\"font:'Times New Roman', Times, serif;font-size:15px;\"><div align=\"center\">$chusohuu</div></td>
      <td style=\"font:'Times New Roman', Times, serif;font-size:15px;\"><div align=\"center\">$serialnumber</div></td>
      <td style=\"font:'Times New Roman', Times, serif;font-size:15px;\"><div align=\"center\">$ngaykd</div></td>
      <td style=\"font:'Times New Roman', Times, serif;font-size:15px;\"><div align=\"center\">$ngaykdtt</div></td>
      <td style=\"font:'Times New Roman', Times, serif;font-size:15px;\"><div align=\"center\">$ngaylv</div></td>
      </tr>";
//}
?>
   <?php } ?>
  ...
  <div class="footer" style="border:1px solid #666666;background:#CCCCCC">
<?php
$page_cr=($start1/$row_per_page)+1;

for($i=1;$i<=$page;$i++)
{
 if ($page_cr!=$i) echo "<a href='tiendocongviec.php?start1=".$row_per_page*($i-1)."&user=$username&nhomsc=$nhomsct'>$i&nbsp;</a>";
 else echo $i." ";
}
?>
</div>
