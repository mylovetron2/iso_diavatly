...
echo "<!DOCTYPE HTML PUBLIC '-//W3C//DTD HTML 4.01 Transitional//EN' 'http://www.w3.org/TR/html4/loose.dtd'>
	...
	<body>";
echo "
<Span class=\"printspan\"><center>XƯỞNG SỬA CHỮA VÀ CHUẨN CHỈNH MÁY<br/>THÔNG BÁO BẢO DƯỠNG ĐỊNH KỲ CÁC THIẾT BỊ CÓ SỬ DỤNG DẦU</center></br></span>
<div class=\"noprint\">
<section class=\"tabs\">
<input id=\"tab-1\" type=\"radio\" name=\"radio-set\" class=\"tab-selector-1\"  onClick=\"window.location.href='baoduongxuong.php'\"/>
...
<input id=\"tab-3\" type=\"radio\" name=\"radio-set\" class=\"tab-selector-3\" onClick=\"window.location.href='thongkebaoduongsddau.php'\" checked=\"checked\"/>
<label for=\"tab-3\" class=\"tab-label-3\">CÁC THIẾT BỊ CÓ SỬ DỤNG DẦU</label>
<div class=\"clear-shadow\"></div>
</section></div>";     
require_once("mte/mte_thongkebaoduongsddau.php");
...
$tabledit->fields_in_list_view = array('stt','mavt','somay','ngaykt','ngaybdtt','loaidau');
...
$tabledit->show_text = array(
	...
	'chiphi'  =>'Chi Phí',
	'ngaybdtt'  =>'Ngày Bảo Dưỡng Tiếp Theo',
	'loaidau'  =>'Loại dầu sử dụng'
);
