...
session_start();
require_once("mte/mte_danhmuclk.php");
...
$tabledit->table = 'linhkien_iso';

# the primary key of the table (must be AUTO_INCREMENT)
$tabledit->primary_key = 'stt';

# the fields you want to see in "list view"
$tabledit->fields_in_list_view = array('stt','tenviettat','tenmota','pn','soluongbandau','vitri','chusohuu','tlkt');
...
$tabledit->fields_required = array('tenviettat');

# visible name of the fields
$tabledit->show_text = array(
	'stt' => 'STT',
	'mavattu' => 'MÃ VẬT TƯ',
	'mamuahang' => 'MÃ MUA HÀNG/NẾU CÓ',
	...
	'giatiendonvi' => 'GIÁ TIỀN/ĐƠN VỊ',
	'soluongbandau' => 'SỐ LƯỢNG',
	'ghichu' => 'TÍNH NĂNG',
	'dungchomay' => 'DÙNG CHO MÁY',
	'thongsokythuat' => 'THÔNG SỐ KT',
	'ngaynhap' => 'NGÀY NHẬP',
	'chusohuu' => 'CHỦ SỞ HỮU',
	'chiunhiet' => 'CHỊU NHIỆT',
	'thanhly' => 'THANH LÝ',
	'hinhanh' => 'HÌNH ẢNH',
	'tlkt' => 'TLKT',
);
...
echo "<Span class=\"printspan\"><center>XƯỞNG SỬA CHỮA VÀ CHUẨN CHỈNH MÁY<br/>DANH MỤC VẬT TƯ/THIẾT BỊ</center></span>";
