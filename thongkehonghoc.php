...
echo "<!DOCTYPE HTML PUBLIC '-//W3C//DTD HTML 4.01 Transitional//EN' 'http://www.w3.org/TR/html4/loose.dtd'>
	...
	<body>";
echo "
<Span class=\"printspan\"><center>XƯỞNG SỬA CHỮA VÀ CHUẨN CHỈNH MÁY<br/>THỐNG KÊ HỎNG HÓC VÀ CÁCH KHẮC PHỤC</center></span>
<div class=\"noprint\">
<section class=\"tabs\">
...
<input id=\"tab-2\" type=\"radio\" name=\"radio-set\" class=\"tab-selector-2\" onClick=\"window.location.href='thongkehonghoc.php'\" checked=\"checked\" />
...
require_once("mte/mte_thongkehonghoc.php");
...
$tabledit->fields_in_list_view = array('stt','mavt','somay','hoso','ngaykt','honghoc','khacphuc','ttktafter','solanhong','nhomsc','bangsl','phieuktsc');
